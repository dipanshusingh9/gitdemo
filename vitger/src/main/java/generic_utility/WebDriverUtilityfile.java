...
public class WebDriverUtilityfile {
	...
	public void MaximiztheBrowser(WebDriver driver) {
	...
	public void SelectDropDown(WebElement Elemant, String option) {
	 ...
	 * 
	 * @param driver
	 * @param waitfor js elemant
	 */
	@SuppressWarnings("deprecation")
	public void waitforPageToloadJSelemant(WebDriver driver ) {
	...
	public void waitforElemanttobeClickable(WebDriver driver , WebElement elemant) {
		WebDriverWait wait = new WebDriverWait(driver,Duration.ofSeconds( IPathConstant.EXPLICITWAIT));
		wait.until(ExpectedConditions.elementToBeClickable(elemant));
	}
	/**
	 * 
	 * @param driver
